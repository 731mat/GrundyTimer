...
<?php
		if ($user->loggedIn) {
			...
			?>><a href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Controller:default")) ?>"><i class="fa fa-tablet"></i> Tablet</a></li>
...
<?php
		if ($user->loggedIn) {
			...
			echo LR\Filters::escapeHtmlText($user->getIdentity()->roles['name']) /* line 76 */ ?></a></li>
...
<?php
		...
		foreach ($flashes as $flash) {
			...
			echo LR\Filters::escapeHtmlText($flash->message) /* line 88 */ ?></div>
<?php
			$iterations++;
		}
?>
...
<?php
	...
	{
		extract($this->params);
		if (isset($this->params['flash'])) trigger_error('Variable $flash overwritten in foreach on line 88');
...
?>
	...
	<script src="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 96 */ ?>/js/bootstrap.min.js"></script>
	<script src="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 97 */ ?>/js/main.js"></script>
<?php
	}
