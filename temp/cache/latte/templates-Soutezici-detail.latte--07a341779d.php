...
<?php
		...
		foreach ($dataCasy as $index => $cas) {
			?>                <th>kolo <?php echo LR\Filters::escapeHtmlText($index) /* line 11 */ ?></th>
<?php
			$iterations++;
		}
?>
...
<?php
		...
		foreach ($dataCasy as $cas) {
			?>                                {  y: <?php echo LR\Filters::escapeJs($cas->time->h*3600 + $cas->time->i*60 + $cas->time->s) /* line 54 */ ?>, legend:"pokus"},
<?php
			$iterations++;
		}
?>
