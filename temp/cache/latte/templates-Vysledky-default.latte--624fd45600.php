            ...
            buttons: [
                {
                    ...
                    message:<?php echo LR\Filters::escapeJs($dataInfo->adress) /* line 39 */ ?>+"  "+<?php
		echo LR\Filters::escapeJs(call_user_func($this->filters->date, $dataInfo->date, '%d.%m.%Y')) /* line 39 */ ?>+"      -   ©GrundyTimer  časomíra ",
                    exportOptions: {
                        modifier: {
                            page: 'current'
                        }
