...
<?php
	...
	{
		extract($this->params);
		if (isset($this->params['kat'])) trigger_error('Variable $kat overwritten in foreach on line 26, 68');
...
<?php
		...
		foreach ($dataKategorie as $kat) {
			?>                    <tr><td><?php echo LR\Filters::escapeHtmlText($kat->name) /* line 27 */ ?></td>
                        <td><?php echo LR\Filters::escapeHtmlText($kat->pocet) /* line 28 */ ?></td></tr>
<?php
			$iterations++;
		}
?>
...
<?php
		$iterations = 0;
		foreach ($dataKategorie as $kat) {
			?>                                {  y: <?php echo LR\Filters::escapeJs($kat->pocet) /* line 69 */ ?>, legendText:<?php
			echo LR\Filters::escapeJs($kat->name) /* line 69 */ ?>, indexLabel: <?php echo LR\Filters::escapeJs($kat->name) /* line 69 */ ?>},
<?php
			$iterations++;
		}
?>
	...
	<script type="text/javascript" src="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 78 */ ?>/js/canvasjs.min.js"></script>
<?php
	}
