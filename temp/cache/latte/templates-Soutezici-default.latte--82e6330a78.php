...
<?php
	...
	{
		extract($this->params);
		if (isset($this->params['soutezici'])) trigger_error('Variable $soutezici overwritten in foreach on line 17');
...
?>        <tr>
            <td><?php echo LR\Filters::escapeHtmlText($soutezici->start_number) /* line 18 */ ?></td>
            <td><?php echo LR\Filters::escapeHtmlText($soutezici->first_name) /* line 19 */ ?></td>
            <td><?php echo LR\Filters::escapeHtmlText($soutezici->last_name) /* line 20 */ ?></td>
            <td><?php echo LR\Filters::escapeHtmlText($soutezici->team) /* line 21 */ ?></td>
            <td><?php echo LR\Filters::escapeHtmlText($soutezici->birth_year) /* line 22 */ ?></td>
            <td><?php echo LR\Filters::escapeHtmlText($soutezici->ref('category','category')->name) /* line 23 */ ?></td>
